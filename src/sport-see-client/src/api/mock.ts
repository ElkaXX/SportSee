...
export const mockUserMainData = (userId: number): UserMainData =>
...
export const mockUserActivity = (userId: number): UserActivity =>
  USER_ACTIVITY.find((user) => user.userId === userId)!;

const USER_AVERAGE_SESSIONS: UserAverage[] = [
  {
    userId: 12,
    sessions: [
      {
...
export const mockUserAverageSessions = (userId: number): UserAverage =>
...
export const mockUserPerformance = (userId: number): UserPerformance =>
